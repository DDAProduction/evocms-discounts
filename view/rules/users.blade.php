<script>
    ...
    webix.ui({
        ...
        head: {
            view: "toolbar", margin: 5, cols: [
                {
                    view: "label", label: "@lang('EvocmsDiscounts::main.rule_users_model_caption')"
                },
                {
                    view: "icon",
                    icon: "wxi-close",
            ...
            rows: [
                {
                    cols: [
                            ...
                            view: "toolbar", cols: [
                                {
                                    ...
                                    placeholder: "@lang('EvocmsDiscounts::main.rule_users_model_filter_by_name')",
                                ...
                                },
                                {
                                    ...
                                    icon: "wxi-filter",
                                    label: "",
                                    tooltip: "@lang('EvocmsDiscounts::main.rule_users_model_search')",
                                    autowidth: true,
                                    click:function () {
                                        ...
                                        $$("users_tree").clearAll();
                                        $$("users_tree").load("{!! $moduleUrl !!}&action=rule-users-search&" + "&checked=" + ids + "&search=" + search);
                        ...
                        },
                        {
                            view: "toolbar", cols: [
                                {
                                    view: "template", align: "middle,middle", template: "@lang('EvocmsDiscounts::main.rule_users_users_with_sale')", height: 10
                                },
                            ]
                        },
                    ]
                },
                {
                    cols: [
                        {
                            view: "list",
                            label: "@lang('EvocmsDiscounts::main.rule_users_user_list')",
                            id: "users_tree",
                            autowidth: true,
                            maxHeight: 400,
                            template:"#title#",
                        ...
                        {
                            view: "list",
                            label: "@lang('EvocmsDiscounts::main.rule_users_selected_user')",
    ...
    let usersRule = {
        ...
        getCaption:function () {
            return '@lang('EvocmsDiscounts::main.rule_users_rule_caption')';
        },
        ...
        addRuleView:function (ruleInnerId,rule) {
            ...
            let obj = {
                ...
                rows:[
                    ...
                    {
                        view: "button",
                        label: "@lang('EvocmsDiscounts::main.rule_users_show_user_list')",
